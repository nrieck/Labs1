...
public class Employee {
    ...
    */
    ...
    private void meetWithHrForBenefitAndSalryInfo() {
        metWithHr = true;
        output.addData(firstName + " " + lastName + " met with Hr on "
            + getFormattedDate());
    }
    ...
    private void meetDepartmentStaff() {
        metDeptStaff = true;
        output.addData(firstName + " " + lastName + " met with Dept. Staff on "
            + getFormattedDate());
    }
    ...
    public void reviewDeptPolicies() {
        ...
        output.addData(firstName + " " + lastName + " reviewed Dept policies on "
            + getFormattedDate());
    }
    ...
    public void moveIntoCubicle(String cubeId) {
        this.cubeId = cubeId;
        this.movedIn = true;
        output.addData(firstName + " " + lastName + " moved into cubicle "
